...
T = TypeVar("T", bound="GetSenderTemplatesResponse")


@attr.s(auto_attribs=True)
class GetSenderTemplatesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_sender_templates_response = cls(
            templates=templates,
        )

        get_sender_templates_response.additional_properties = d
        return get_sender_templates_response
